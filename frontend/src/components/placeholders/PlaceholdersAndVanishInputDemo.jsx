  ...
  return (
    (<div className="h-[40rem] flex flex-col justify-center  items-center px-4 bg-[#f59e0b]">
      ...
      {markdownText.length > 0 &&
        <div>
          <div className="bg-black text-white p-4 mt-2 rounded-lg shadow-lg max-w-full md:max-w-lg mx-auto">
            <div className="bg-gray-800 text-gray-200 font-mono p-4 rounded-md border border-gray-600 max-h-64 overflow-y-auto">
              {isLoading ? <p className="animate-pulse">Loading...</p> : <ReactMarkdown>{markdownText}</ReactMarkdown>}
            </div>
          </div>
